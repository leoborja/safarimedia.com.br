  ...
  return (
    <>
      <div
        data-open={isOpen}
        onClick={toggleForm}
        className="bg-[#0B3D2E]/70 fixed hidden left-0 top-0 w-full h-full z-40 opacity-0 data-[open='true']:opacity-100 transition-all duration-500 data-[open='true']:block data-[open='true']:animate-fade-in"
      />
      <div
        data-open={isOpen}
        className="md:pt-7 pt-20 max-w-full fixed data-[open='true']:right-0 -right-[100%] top-0 p-7 bg-[#0B3D2E] text-white z-50 md:min-w-[640px] h-full transition-all duration-500 overflow-y-auto"
      >
        ...
        <div className="relative z-20">
          ...
          <div className="max-w-md mx-auto md:pt-10">
            ...
            <p className="text-[#A3D9A5] text-sm mt-2">
              {t('form.description')}
            </p>
            <form
            ...
            >
              <div>
                ...
                <input
                  ...
                  className="bg-[#074D36] text-white rounded-md p-2 w-full focus:outline-none focus:ring-2 focus:ring-[#A3D9A5]"
                />
              </div>
              ...
              <div className="flex gap-4 items-center flex-wrap md:flex-row flex-col md:justify-normal justify-center">
                <Button
                  type="submit"
                  className="!py-3 text-white md:w-auto w-full bg-[#09603F] hover:bg-[#074D36]"
                >
                  {t('form.send_message')}{' '}
                  {isLoading ? (
            ...
            <div className="text-center md:text-left md:flex-row flex-col mt-6 gap-6 flex border rounded-lg border-[#09603F] bg-[#074D36] p-6 items-center justify-between">
              <div className="text-white">
                <span className="text-xl font-medium">
                  {t('form.highlight_primary.pre')}
                </span>
                <br />
                <span className="text-[#A3D9A5] text-sm whitespace-nowrap">
