...
function Hero() {
  ...
  return (
    <>
      ...
      <header className="bg-[#0B3D2E] bg-hero bg-cover sm:bg-top bg-left-60 min-h-[760px] overflow-hidden">
        ...
        <div className="container relative mt-40 z-20">
          ...
          <div className="max-w-3xl">
            ...
            >
              <Button onClick={toggleForm} appearance="primary" className="bg-[#09603F] hover:bg-[#074D36] text-white">
                <Chats size={20} />
                {t('send_message')}
              </Button>

              <div className="flex text-[#A3D9A5] items-center gap-4 max-w-[300px]">
                <Crosshair size={48} className="flex-grow-0 text-[#A3D9A5]" />
                {t('hero.highlight')}
              </div>
            </div>
          </div>
