...
function Footer() {
  ...
  return (
    <footer className="bg-secondary-700 text-gray-150 py-16 lg:py-24 mt-20 lg:mt-0">
      <div className="container flex flex-col gap-12">
        <div className="flex justify-between flex-wrap">
          <div className="text-center lg:text-left">
            ...
            <p className="text-white/50 lg:m-0">
        ...
        <div className="flex flex-wrap">
          ...
          <div className="lg:hidden w-full bg-white/30 h-[1px] mb-12" />

          <div className="lg:ml-auto lg:mr-0 mx-auto flex gap-8">
            <div className="flex gap-4 lg:flex-row flex-col lg:items-center">
              <div className="bg-primary-700 w-10 flex h-10 text-gray-300 rounded-md justify-center items-center">
                <At size={24} />
              </div>
